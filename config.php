...
define('FIRST_DSN',  DATABASE_DRIVER.'://'.DATABASE_USER.':'.urlencode(DATABASE_PASSWORD).'@'.DATABASE_HOST.':'.DATABASE_PORT.'/'.DATABASE_NAME);
define('SECOND_DSN',  DATABASE_DRIVER.'://'.DATABASE_USER_SECONDARY.':'.urlencode(DATABASE_PASSWORD_SECONDARY).'@'.DATABASE_HOST_SECONDARY.':'.DATABASE_PORT_SECONDARY.'/'.DATABASE_NAME_SECONDARY);